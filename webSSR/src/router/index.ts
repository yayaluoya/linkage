...
import { createMemoryHistory, createRouter, createWebHistory, RouteRecordRaw_ } from 'vue-router';
...
//打印所有路由信息
Env.ifDev && Env.ifC && console.log('路由列表', routeList);

const router = createRouter({
  //一定要判断端，s端必须使用createMemoryHistory
